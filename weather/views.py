...
def weather(request):
    if request.method == 'POST':
        url = 'http://dataservice.accuweather.com/locations/v1/cities/search?apikey=HtVYxOGz14059HOTIrVQuqA6Qs3wbLHl&q={}'
        ...
        if list_of_data:
            ...
            weather_url = 'http://dataservice.accuweather.com/currentconditions/v1/' + location_data[
                "location_key"] + '?apikey=HtVYxOGz14059HOTIrVQuqA6Qs3wbLHl&details=true'
